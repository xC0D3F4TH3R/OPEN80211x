...
eap_server=1
eap_user_file={econf}
mana_wpaout={CONFIG.session_dir / f"mana-{self.ssid}.handshakes"}
mana_eapsuccess=1
mana_credout={cred_out}
mana_pskout={CONFIG.session_dir / f"mana-{self.ssid}.psk"}
auth_algs=1
...
mana_wpa=1
mana_credout={cred_out}
mana_pskout={CONFIG.session_dir / f"karma-{self.ssid}.psk"}
""", encoding="utf-8")
        else:
            hconf.write_text(f"""interface={self.iface}
ssid={self.ssid}
